...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Halo Sayangnyaa acuu", "Aku punya pertanyaan nii", "question").then(function () {
      ...
      Swal.fire("Awasss yaaa kalooo boong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${nama} kamuu sayang ga sama ${ata}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${ata} juga sayang banget sama ${nama}`).then(function () {
                Swal.fire({
                  ...
                  Swal.fire(`Makasih banget ya byy udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang ${nama} kangen ga sama ${ata}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhuhuhuhuhu iya ${ata} juga kangen bangett samaaa ${nama} , makasihhh yaa :)`).then(function () {
